      ...
      <div className="bg-slate-950 relative overflow-hidden pb-12 md:pb-24">
        ...
        <header className="w-full border-b border-white/5 bg-transparent sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/cadastro" className="text-sm font-semibold bg-white hover:bg-slate-200 text-slate-900 px-5 py-2.5 rounded-lg transition-all shadow-[0_0_15px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.2)]">
                Criar conta
              </Link>
            </div>
          </div>
        ...
        <section className="w-full pt-20 flex flex-col items-center text-center px-6 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            {/* CTAs Principais - Roteamento Inteligente */}
            <div className="flex flex-col sm:flex-row justify-center gap-4 w-full sm:w-auto">
              <Link to="/cadastro" className="h-14 px-8 flex items-center justify-center rounded-xl bg-white text-slate-900 font-bold shadow-[0_0_30px_rgba(255,255,255,0.15)] hover:bg-slate-100 transition-all hover:scale-105 active:scale-95 text-lg">
                Montar minha carteira
              </Link>
              <Link to="/cotacao" className="h-14 px-8 flex items-center justify-center rounded-xl bg-slate-800/50 border border-white/10 text-white font-medium hover:bg-slate-800 transition-colors backdrop-blur-sm text-lg">
                Testar terminal
              </Link>
            </div>
          </div>

          {/* MOCKUP ASPIRACIONAL DO PRODUTO */}
      ...
      <section className="w-full bg-slate-50 py-12 border-b border-slate-200">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-10 md:gap-24 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            <span className="text-xl font-bold text-slate-800 tracking-tight">Tesouro Direto</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[auto]">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                <div className="w-full bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <span className="text-xs font-mono font-bold text-blue-700 bg-blue-50 px-2 py-1 rounded border border-blue-100">Fundo de Papel</span>
                  </div>
            ...
            <div className="md:col-span-4 bg-slate-50 p-8 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-500 group flex flex-col justify-between">
              ...
              <div className="flex items-center gap-3 bg-white border border-slate-200 p-4 rounded-xl shadow-sm">
                ...
                <span className="text-xs font-mono font-bold text-slate-600 uppercase tracking-widest">Sincronização Ativa</span>
              </div>
            </div>
      ...
      <section className="w-full bg-blue-600 py-24 pb-32">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-blue-100 mb-10 text-lg max-w-2xl mx-auto">
            Abandone as planilhas complexas hoje. Cadastre-se gratuitamente ou teste o nosso terminal de mercado aberto.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/cadastro" className="inline-flex h-14 px-10 items-center justify-center rounded-xl bg-slate-950 text-white font-bold shadow-2xl hover:bg-slate-900 transition-all duration-300 hover:scale-105 active:scale-95 text-lg">
              Criar conta gratuita
            </Link>
            <Link to="/cotacao" className="inline-flex h-14 px-10 items-center justify-center rounded-xl bg-blue-500/50 border border-blue-400 text-white font-bold hover:bg-blue-500 transition-all duration-300 text-lg backdrop-blur-sm">
              Terminal B3
            </Link>
          </div>
        </div>
